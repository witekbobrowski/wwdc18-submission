...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        deviceViewController.viewModel = DeviceViewModelImplementation(operatingSystemViewModel: OperatingSystemViewModelImplementation(),
                                                                       controlPanelViewModel: ControlPanelViewModelImplementation())
